...
fn seed_starter_data(conn: &Connection) -> rusqlite::Result<()> {
    ...
    let groups: Vec<(&str, &str, Vec<(&str, Vec<&str>)>)> = vec![
        ...
        ("Boredom", "The restless flatness of under-stimulation — energy with nowhere to go", vec![
            ("Physical Signals", vec![
                "slumping lower in the chair by degrees until the spine has gone from posture to punctuation",
                "chin propped in the palm, the hand carrying the full weight of a head that can't be bothered to hold itself up",
                "a slow, theatrical sigh — long enough to register in the room, quiet enough to be deniable",
                "tapping a foot in a rhythm that drifts, stops, restarts a few beats off",
                "clicking a pen open and shut, open and shut, a metronome with nothing to measure",
                "rolling the head in slow circles as if reminding the neck it still exists",
                "staring at the clock, looking away, looking back a full minute later to find the second hand has moved about ten ticks",
                "doodling in the margins — spirals, cubes, the same name over and over in different fonts",
                "picking at a cuticle, a hangnail, the corner of a sticker — anything that gives the fingers a task",
                "the slow blink that lasts half a second too long, and the micro-jolt when the eyes spring back open",
                "pulling the phone out, locking it, unlocking it thirty seconds later to find the same empty notification screen",
                "swinging one leg under the table, rhythm building until the knee knocks wood and the whole body freezes, caught",
                "stretching elaborately — arms overhead, back arching, a small groan at the top — a full-body protest against stillness",
                "the yawn that arrives without warning and stretches the jaw wider than seems dignified, eyes watering at the edges",
                "tracing a fingertip along the grain of a table, following the line to its end, starting over at the next one",
                "shifting position every thirty seconds — leg crossed, leg uncrossed, elbow on armrest, elbow off, nothing ever comfortable",
                "the head tipping slowly back until it meets the wall or the top of the chair, eyes closing for an indulgent half-second",
                "rearranging the objects on the desk into careful patterns — pen parallel to notebook, mug squared with the edge — for no reason anyone could name",
                "flicking the cap of a water bottle on and off, on and off, until someone nearby glances over",
                "balancing a pencil across the back of the hand, letting it fall, picking it up, balancing it again",
            ]),
            ("Internal Sensations", vec![
                "a strange, itchy restlessness under the skin — the body wanting to move without anywhere useful to send it",
                "the slow descent of alertness — not quite sleepy, just the sense that everything in the room has drifted half a step further away",
                "eyelids developing a subtle weight, as if the muscles holding them open have been asked to do slightly more work than usual",
                "a hollow, low-grade hunger that isn't really hunger — the stomach volunteering food as something, anything, to do",
                "the body temperature feeling mildly wrong — too warm, too cool — the skin complaining because nothing else is happening to complain about",
                "a dull ache settling into the lower back and hips from sitting still past the point the body was designed for",
                "time turning elastic — minutes stretching into something longer while the clock hand refuses to move accordingly",
                "the muscles in the legs tingling with unspent energy, the calves twitching with the urge to walk somewhere, anywhere",
                "a vague, unfocused pressure building behind the eyes — the beginning of the kind of headache that has no real cause",
                "the mouth going dry, the tongue casting around for something to taste, chew, drink — the senses reaching for input that isn't arriving",
                "a low static humming through the nervous system — not quite anxiety, not quite irritation, the body reporting that something is wrong without being able to name it",
                "the heart rate flat, the breath shallow, the whole metabolism idling like a car stopped at a red light that won't change",
            ]),
            ("Mental Responses", vec![
                "the mind wandering into old memories for no particular reason, just because anywhere is better than here",
                "composing elaborate plans for later — meals, errands, conversations — plans that will be completely forgotten the moment anything real happens",
                "rehearsing arguments you've already won, inventing witty things you should have said weeks ago",
                "the bizarre urge to invent a problem just to have something to solve",
                "counting things — ceiling tiles, commas in a paragraph, the number of times the speaker says 'um' — the brain desperate for any task with a structure",
                "a creeping resentment toward whoever or whatever is holding you here, even when nothing is really holding you but politeness",
                "the thought intruding, unbidden: is this really what I am spending my life on",
                "a sharp, unwelcome awareness of mortality — the realization that this empty hour is one that cannot be returned",
                "inventing escape routes — thirsty, bathroom, forgotten something in the car — each excuse more plausible than the last",
                "the stubborn hope that something interesting is about to happen, followed by the quieter certainty that it is not",
                "drifting into fantasies of other lives — other jobs, other cities, other versions of yourself — vivid enough to feel briefly like betrayal",
                "the nagging sense that you should be doing something — anything — alongside the complete inability to decide what",
                "thoughts loosening, losing edges, running together until a whole minute passes without any of them leaving a mark",
                "the mind reaching for its phone the way a tongue reaches for a missing tooth",
            ]),
            ("Suppression Cues", vec![
                "the carefully neutral expression held in place by conscious effort, the cheek muscles slowly fatiguing",
                "nodding at intervals calibrated to suggest engagement without requiring comprehension",
                "leaning forward with hands clasped, miming interest while the eyes go soft and just slightly out of focus",
                "a small, polite smile that has not changed shape in forty minutes",
                "taking notes that are really just the speaker's words copied down — because writing looks like listening, and looking like listening is what the room requires",
                "the occasional 'mm' and 'yes' deployed strategically during pauses, pattern-matched from tone rather than content",
                "making eye contact a beat or two longer than natural, overcorrecting for the urge to look anywhere else",
                "the phone held just below table height, thumb moving across the screen in a rhythm only the user can feel",
                "drinking water in small, unnecessary sips — an excuse to move the body without appearing to",
                "asking a question so the speaker will switch to a topic easier to endure",
                "laughing half a beat late at a joke that registered only as tone, not content",
                "the discreet stretch disguised as a shift in posture — shoulder rolled, ankle flexed, face held absolutely still",
                "pinching the inside of a thigh under the table to generate enough sensation to stay present",
                "writing the time at the top of the page every ten minutes — a secret countdown disguised as note-taking",
            ]),
        ]),
        // ── Complex / Mixed States ──
        ("Ambivalence", "Genuinely contradictory feelings held at once toward the same person or situation", vec![
            ("Physical Signals", vec![
                "the head tilting one way, then the other — the body unconsciously miming the weighing of two answers",
                "a hand lifting as if to reach for something, then falling halfway back to the side",
                "taking a half-step forward, stopping, shifting weight back onto the rear foot",
                "turning toward the door, turning back to the room, turning toward the door again",
                "picking up an object, setting it down, picking it up a few seconds later and turning it in the other hand",
                "the shoulders rising and falling in a long, uncertain shrug that never commits to a shape",
                "opening the mouth to speak, closing it, opening it again with a completely different first word",
                "writing a sentence, crossing it out, rewriting the same sentence with a negation — and crossing that out too",
                "nodding and shaking the head almost in the same motion — a small, involuntary wobble neither answer produced on purpose",
                "standing in a doorway neither inside nor outside, one hand flat on the frame",
                "hovering over the send button on a phone for a full minute — not pressing, not putting the phone down",
                "fingers pausing over a keyboard key for seconds at a time before finally retracting",
                "a smile that half-forms and dies before it can decide what it means",
                "eyes flicking between two people, two doors, two options, never settling on either",
                "the body angled diagonally to both choices — not facing either fully, as if physical commitment would mean psychological commitment",
                "rubbing the back of the neck slowly while the mouth works on something that won't come out",
                "starting to laugh, catching it mid-sound, redirecting it into a faint hum",
                "a hand running down the face slowly, pausing at the mouth, as if physically holding back an answer that has not yet been chosen",
                "rocking subtly on the heels, back and forth, the whole body a pendulum",
                "reaching for a drink, then a napkin, then the drink again — the hand hunting for an excuse to be busy",
            ]),
            ("Internal Sensations", vec![
                "a tightness across the chest that isn't fear — something closer to being quietly stretched in two directions at once",
                "the stomach lurching forward when you picture one outcome, then lurching the opposite way at the other",
                "a headache forming behind the eyes from holding two bright things wide open simultaneously",
                "the heart rate rising and falling with no rhythm, matching whichever thought is currently winning",
                "a low, rolling nausea that arrives whenever the decision gets close enough to touch",
                "the throat constricting around the word about to come out, as if the body itself is objecting to commitment",
                "heat climbing, subsiding, climbing again in the face and neck — the physiology of not knowing which side to be on",
                "palms going clammy without exertion — the sweat of indecision, a thinner and cooler sweat than fear",
                "the muscles of the jaw and neck locked not with anger but with the effort of holding contradictions apart",
                "a fatigue heavier than it should be for the time of day — two opposing thoughts burning twice the fuel",
                "the sensation of vertigo on still ground — the inner ear acting as if the floor itself is rocking",
                "a flutter just below the sternum, like a bird trying to choose a branch and giving up halfway there",
                "the body registering the decision as a physical weight that shifts from one shoulder to the other and never lands",
            ]),
            ("Mental Responses", vec![
                "the mind running two arguments in parallel, each fully formed, each refusing to yield ground to the other",
                "reaching a decision, feeling relief for exactly as long as it takes to think of the first counterargument",
                "wanting them, and wanting to be free of them, in the same breath — neither feeling diluted by the presence of the other",
                "the dark, brief wish that someone else would make the choice and take the blame with it",
                "the awareness that either path will require grieving the one not taken, and the unwillingness to start grieving either",
                "cataloguing the reasons for, then the reasons against, with an accountant's cold neutrality — and the final column always balancing",
                "imagining a full life on both sides of the fork, each vivid enough to feel like a memory already made",
                "the conviction, shifting hour by hour, that you finally know what you want — followed by the quieter certainty that you'll change your mind by evening",
                "the refusal of the mind to stop arguing with itself even when the body is begging for a verdict",
                "a strange, guilty envy of people who can want one thing only, cleanly, without the second voice",
                "the creeping suspicion that the ambivalence itself is the answer — and the refusal to accept that an answer",
                "both feelings at full volume, undiluted — love and resentment, want and dread — neither able to drown the other out no matter how long you listen",
                "catching yourself defending a position aloud to a friend while privately believing the opposite with equal force",
                "the specific torment of knowing you are not confused — you see both sides perfectly, and that clarity is what makes choosing unbearable",
            ]),
            ("Suppression Cues", vec![
                "giving a decisive answer out loud while the hand under the table keeps turning a ring around and around",
                "the overly firm 'yes' — delivered with a conviction calibrated to silence the speaker's own doubt, not to serve the question",
                "laughing off the question with a joke so someone else has to pick up the conversation",
                "saying 'I've made up my mind' three times in the same conversation, each time slightly louder",
                "answering with a quote or a principle instead of a preference — borrowing someone else's certainty to wear as your own",
                "redirecting: 'what do you think?' — handing the question to the other person and calling the deflection generosity",
                "the careful, lawyerly phrasing that technically commits to nothing while sounding like resolution",
                "performing enthusiasm at a volume that would embarrass genuine enthusiasm",
                "announcing the decision in public — early, loud — so that the social cost of reversing it becomes too high to pay",
                "changing the subject with practiced speed every time the topic threatens to demand a real choice",
                "going very still — the stillness of a computer with too many windows open, nothing visibly happening on the surface, everything straining underneath",
                "the bright, brittle 'of course!' that arrives a half-second too fast and a half-note too high",
            ]),
        ]),
        ("Schadenfreude", "The guilty pleasure in another's misfortune — often immediately followed by shame", vec![
            ("Physical Signals", vec![
                "a smile breaking through before the face can catch it, held for half a second, pulled back into something more neutral",
                "the corners of the mouth twitching upward in small, involuntary jerks despite conscious effort to hold a straight face",
                "a hand clapped over the mouth to hide a grin that arrived uninvited",
                "ducking the head to break eye contact with the room while the smile wins anyway",
                "turning away on a manufactured excuse — cough, drink, phone, window — to let the expression run its course unobserved",
                "the 'oh no' delivered with an upward inflection that undoes the sympathy entirely",
                "leaning forward for every new detail of the misfortune, hungry for the next piece",
                "passing the news on to one specific friend — the one who will understand without judgment — before telling anyone else",
                "reading the headline a second time, slower, savoring the words like a sentence from a favorite book",
                "a sudden laugh escaping at the wrong moment, converted mid-sound into a cough that fools no one",
                "the small, private nod when no one is looking — judgment rendered, verdict appreciated",
                "a quick, instinctive glance around the room to see who witnessed your face",
                "forwarding the article, the post, the clip with 'saw this, thought of you' as cover for the real message",
                "the eyes brightening at the wrong sentence of someone else's bad-news story",
                "a lift at the corners of the mouth that refuses to let go for the next twenty minutes no matter how many times it's consciously smoothed",
                "replaying the mental clip — the fall, the wobble, the announcement — and feeling the face lift again each time",
                "rocking back slightly in the chair — a small expansive gesture, the body taking up a little more space than a moment ago",
                "the slight, visible intake of breath, almost a gasp of delight, a half-beat before the social mask engages",
                "saving the screenshot, bookmarking the link, returning to it later like a small treat in the pocket",
                "picking up a cup or utensil to cover the mouth while the grin subsides at its own pace",
            ]),
            ("Internal Sensations", vec![
                "a warm lift through the chest — the body's reward system ringing a bell it knows is forbidden, but ringing it anyway",
                "a sudden lightness in the shoulders, as though someone has quietly lifted a weight you had stopped noticing",
                "the heart rate ticking up — not with threat but with pleasure, the body welcoming good news into the bloodstream",
                "a fizz in the stomach that sits close to excitement but sharper, more targeted, more specific",
                "the muscles of the face relaxing into the expression they'd wanted to be in all along",
                "heat climbing into the cheeks — not the flush of embarrassment but the flush of pleasure caught in the act",
                "a tingling alertness, every sense sharpening a degree — the world suddenly more interesting than it was five minutes ago",
                "the jaw and neck letting go of a tension you didn't realize had been gripping them for weeks",
                "a quick, clean hit of something almost like vindication — the body cashing a long-held internal IOU",
                "appetite returning unexpectedly, arriving alongside the news as though the two belong together",
                "the pleasant, dangerous warmth of feeling momentarily taller than you did this morning",
                "a small internal shiver — the pleasure arriving in a wave you can feel move through the torso",
            ]),
            ("Mental Responses", vec![
                "a fast, private calculation — they had it coming, and I was right about them all along",
                "the mental image replaying on a loop, polished a little brighter with each return",
                "an instant, elaborate rehearsal of who you're going to tell first, and in what order",
                "the guilty recognition that this pleasure is bigger than the scale of the misfortune warrants",
                "the conviction arriving bright and sudden: this is the universe correcting an imbalance only I could see",
                "the quiet relief of your own position feeling, by comparison, suddenly more stable",
                "reaching for justifications faster than for the feeling itself — they brought it on themselves, they had warnings, they were overdue",
                "a thrill that feels like winning a game you weren't playing",
                "the forbidden thought arriving fully formed: I hope this gets worse before it gets better",
                "an intrusive, vivid flicker of imagining their face in the moment they realized",
                "a scan of the nearby faces for a co-conspirator — the hunt for someone whose smile will give you permission",
                "the envy that has been chewing at you for weeks going suddenly, beautifully quiet",
                "the shame arriving a few seconds behind the pleasure — softer at first, then louder, then insistent",
                "a small internal fight between the part that wants to savor this and the part that knows better than to feel it at all",
            ]),
            ("Suppression Cues", vec![
                "arranging the face into a mask of concern while the eyes refuse to match the script",
                "saying 'oh no, that's terrible' in a tone exactly one degree too bright",
                "adding 'I feel awful for them' immediately after — loud enough to convince the room, and not quite loud enough to convince yourself",
                "pressing the lips together hard enough to whiten them, as if the smile could be physically held inside",
                "the overperformance of sympathy — too many words, too fast, every sentence a beat ahead of the one before, the whole speech overcompensating for the leak",
                "covering the mouth with a hand for the entire conversation, under the guise of thoughtful listening",
                "looking at the floor while someone delivers the bad news, because the floor is easier to control than the face",
                "deploying a heavy, theatrical sigh as cover for what is really a sigh of satisfaction",
                "the careful 'well, that's a shame' — six syllables designed to deflect suspicion while committing to absolutely nothing",
                "refusing to comment further and changing the subject with unusual speed, while the inner monologue keeps replaying uninterrupted",
                "excusing yourself on a thin pretext so the grin can run its course in the bathroom mirror, alone",
                "offering to help with something you know will not be accepted — the performance of virtue deployed as counterbalance to the feeling underneath",
            ]),
        ]),
        ("Hiraeth", "Longing for a home, time, or self that may never have fully existed — sorrow with a beautiful edge", vec![
            ("Physical Signals", vec![
                "eyes going soft and focusing on a middle distance that is not in the room",
                "a hand pressing flat to the chest, slowly, without any conscious decision to put it there",
                "the whole body quieting when a certain song or accent or phrase arrives unexpectedly from another table",
                "lips moving silently in a language no longer spoken every day",
                "the head tilting to one side, listening to something that isn't playing",
                "a slow, audible breath — long and somehow incomplete — as if the lungs are reaching for an air they remember",
                "tracing the rim of a cup with a fingertip, eyes on nothing in particular",
                "standing still in a doorway when a breeze carries the wrong season into the room",
                "stopping mid-sentence when a word in the old tongue rises up and refuses to be translated into the new one",
                "the slow, unconscious humming of a tune whose words you can't quite recall anymore",
                "reaching toward a photograph on the shelf and then not picking it up",
                "a smile arriving alongside the moisture in the eye, neither one correcting the other",
                "a hand running along an object brought from the old place — a cloth, a bowl, a wooden spoon — mapping it the way fingers read braille",
                "the gaze drifting to the horizon — to the hills or the sea or the line of the skyline — as if the landscape were a letter being read",
                "closing the eyes briefly when a specific smell arrives — peat, brine, rain on stone, coal fire, the inside of someone's kitchen",
                "a long pause before answering the simple question 'where are you from'",
                "the hand going to a necklace, a ring, a coin — a small object carried from the place that made you",
                "sitting down slowly, as if the weight of the body had shifted without warning",
                "cooking a dish from memory, following no recipe, tasting it and being briefly, entirely elsewhere",
                "the voice softening and slowing the moment the old place is named aloud, as if in the presence of something holy",
            ]),
            ("Internal Sensations", vec![
                "a warmth rising through the chest at exactly the same time as an ache — the two refusing to separate from one another",
                "the lungs feeling as if they have forgotten the precise shape of a particular air",
                "a tightness at the base of the throat that isn't quite sadness and isn't quite joy and is somehow more than both",
                "heat gathering behind the eyes at an unexpected trigger — a voice, a word, a chord struck on the radio",
                "the body going still the way it only does when something important is being remembered",
                "a slow, felt heaviness in the bones, as if the pull of a different gravity had briefly reasserted itself underneath the local one",
                "the heart pulling sideways, toward a direction that does not exist on any map you own",
                "a literal stomach hunger for a bread, a soup, a taste you haven't had in years and cannot get here",
                "the skin remembering a particular cold or damp or warmth that this climate will never reproduce, and aching faintly for it",
                "a lightness and a heaviness occupying the chest at the same moment, each giving the other its definition",
                "the sensation of being briefly fuller than yourself — some older, unlived self sitting down quietly inside the present one",
                "a long, soft sigh the body releases on its own — a thing it had been holding without noticing",
            ]),
            ("Mental Responses", vec![
                "the clear, painful knowledge that returning would not give the home back — the home lives in a past you can no longer enter, not in a place you can fly to",
                "the suspicion that the place you are longing for was never quite as you remember it — and the quiet refusal to let that suspicion lessen the longing",
                "an acceptance that this ache will never fully resolve, and the strange relief of stopping the fight to resolve it",
                "the mental composition of a place from fragments — a kitchen, a light, a hill, a voice — assembling something that exists nowhere but inside the longing itself",
                "memories arriving unsummoned and almost too bright, then leaving a residue the day cannot dissolve",
                "the sudden, disorienting awareness that you have become someone a younger version of you would not quite recognize on the street",
                "wondering whether the language you dream in is still the one you think in when you're tired",
                "a thought arriving first in the old tongue, and the small delay while you translate it for the people in the room",
                "the feeling of being two people at once — the one who is here now, and the one who still walks the old lanes at dusk somewhere in the back of the mind",
                "the awareness that anyone you try to explain this to will only half understand it, and the peaceful acceptance of that",
                "the specific grief of realizing the old people who would have understood the feeling in its own language are gone, and took the word for it with them",
                "a sense of belonging more strongly to a place you cannot live in than to any of the places you currently do",
                "the contemplative, almost religious stillness of knowing this is simply how it is now — that some homes are carried inside rather than returned to",
                "the thought arriving without bitterness: a part of me never left, and a part of me can never go back, and both parts are true",
            ]),
            ("Suppression Cues", vec![
                "waving a hand dismissively — 'oh, it's a long story' — when asked where home is",
                "translating the old word for the feeling into something flatter and less true to save the effort of explaining what was lost in translation",
                "laughing off an unexpected emotional surge with 'sorry, that song got me for a second'",
                "changing the subject quickly when the conversation drifts toward place, toward origins, toward language",
                "the quick blink and the manufactured cough when a scent triggers the ache in a public place without warning",
                "offering a tourist's version of the old place — the summary the listener actually wants — instead of the real one",
                "saying 'I don't really miss it' with a smile that doesn't quite land on the mouth",
                "excusing yourself to the bathroom or the kitchen when the feeling rises in company and needs a minute alone to pass",
                "swallowing a word in the mother tongue and substituting the nearest English one, even when the English one is not really the same word",
                "the careful editing of stories about the old place into anecdotes — entertaining, surface-level, safely translatable",
                "looking out the window for a beat too long after someone mentions the old country, then returning to the conversation with a practiced smile",
                "the determined pivot back into the current moment — the current city, the current name, the current life — before the longing can claim any more of the evening",
            ]),
        ]),
        ("Overwhelm", "The feeling that demands exceed capacity — everything pressing in at once", vec![
            ("Physical Signals", vec![
                "sitting very still in the middle of a room surrounded by things that need doing, unable to start any one of them",
                "the head dropping forward into both hands, the fingers pushing up into the hair",
                "eyes going wide and then closing, long, as if shutting off the input for a moment would be enough",
                "a hand pressed flat to the sternum, the breath held, then released in a shaky, incomplete exhale",
                "the mouth opening slightly without speaking — the air refusing to organize itself into a sentence",
                "standing up, walking two steps, sitting back down in the same place with nothing accomplished by the journey",
                "the shoulders riding up toward the ears and staying there, a bracing posture with no enemy in the room",
                "a hand passing over the face from forehead to chin, slowly, as if trying to wipe the situation off",
                "starting three sentences in a row and abandoning each one halfway through",
                "opening a tab, a drawer, a folder, and forgetting within seconds what was being looked for",
                "tears arriving without a specific thought attached — the body's overflow valve releasing under pressure that has nowhere else to go",
                "the hands doing small, useless tasks — smoothing a placemat, aligning a pen, closing a laptop lid half an inch",
                "a long, audible exhale with a tremor climbing in it at the top of the breath",
                "flinching at a knock, a notification, a voice — sounds landing harder than they should",
                "the eyes filling at a perfectly ordinary question and blinking hard to pretend otherwise",
                "staring at a to-do list without reading it, the items refusing to resolve themselves into words",
                "picking up the phone to answer something, unlocking it, locking it, setting it back down, and not quite knowing why",
                "a hand going to the back of the neck, squeezing, releasing, squeezing again",
                "speaking in fragments — 'I just — I can't — there's too much — '",
                "sitting down on the floor in an unusual spot — at the foot of a bed, against a cupboard, beside a door — as if standing upright had become a luxury the body could no longer afford",
            ]),
            ("Internal Sensations", vec![
                "the chest tightening in a way that corresponds to no specific threat — only to the sum of everything at once",
                "breath going shallow and rapid without permission, the lungs unwilling to fill all the way to the bottom",
                "the heart rate climbing steadily even while the body is sitting perfectly still",
                "a heaviness settling across the shoulders and back, as though the weight of every unfinished thing were being distributed physically",
                "the stomach clenching into a small hard knot while appetite flattens into nothing",
                "a ringing, humming pressure in the ears — everything in the room sounding a shade too loud",
                "the skin of the face going tight and hot, a flush without embarrassment to justify it",
                "a tremor in the hands that won't quite settle, even when they're resting flat on a surface",
                "a hollow, sickly feeling behind the sternum — the body registering too much demand as physical illness",
                "heat building behind the eyes with no tears quite ready to come — pressure without release",
                "the particular exhaustion of muscles that have been tense for hours without being used for anything",
                "a dizzy, off-balance feeling on standing, as if the floor had tilted a few degrees without announcing itself",
                "the strange cold of the hands and feet while the chest and face are burning — blood pulled toward the core while the periphery goes quiet",
            ]),
            ("Mental Responses", vec![
                "the thinking brain going quiet — not calm, but offline, like a radio losing signal in a tunnel",
                "an inability to decide what to do first, which turns doing anything at all into an impossibility",
                "the awareness that this feeling is larger than the events causing it, and the quieter knowledge that the awareness changes nothing",
                "a racing internal catalogue of everything that needs to be done, each item bumping the last one further out of focus",
                "the sudden, specific certainty that you cannot possibly manage all of this, followed immediately by the smaller, heavier certainty that you will have to",
                "the thought looping: where do I start, where do I start, where do I start — and never landing on an answer",
                "the urge to run — not toward anything, just away from the size of the situation",
                "the world narrowing to a tunnel — every room beyond this one ceasing to feel quite real",
                "a strange, detached calm sliding in behind the panic — the brain protecting itself by going slightly numb at the edges",
                "forgetting ordinary words mid-sentence — spoon, keys, the name of the street you live on",
                "a creeping certainty that everyone else can handle what you cannot, with the shame of that thought waiting just underneath",
                "the mind refusing to rank the demands — every task feeling equally urgent, which means none of them can be chosen",
                "the realization that sleep tonight will not fix any of this, and tomorrow will start with the same pile exactly where it was left",
                "a desperate, childlike bargaining reflex: if I could just stop time for one hour, just one, I could catch up",
            ]),
            ("Suppression Cues", vec![
                "a bright, controlled 'I'm fine, just busy!' delivered from a face that is very obviously not fine",
                "the forced smile held in place through a meeting while the hands under the table grip each other hard enough to whiten",
                "excusing oneself for water, for a bathroom break, for fresh air — needing sixty seconds alone simply to reset",
                "laughing it off with 'it's been one of those weeks' while mentally cataloguing what 'those weeks' actually contains",
                "breathing slowly and deliberately while someone else is speaking, counting the breaths to stay present in the conversation",
                "the careful, measured voice — every word chosen slowly to avoid the break that would come with a faster pace",
                "redirecting the conversation to the other person's day — anything that stops the question coming back around",
                "checking off small, pointless tasks just to feel competent at something — aligning a stack of papers, replying to an easy email instead of the hard one",
                "the mantra repeated silently while nodding: hold it together, hold it together, just until they leave",
                "a tight, too-bright 'no, no, I've got it' when help is offered — refusing the one thing that would actually lower the load",
                "holding eye contact a beat too long while not hearing a word being said, the face performing attention while the mind is somewhere else entirely",
                "the door closing behind the last visitor and the body immediately folding — knees buckling, shoulders collapsing, the mask coming off all at once",
            ]),
        ]),
        ("Betrayal", "The specific pain of trust violated by someone who was supposed to be safe — a wound that rewrites the past as it opens", vec![
            ("Physical Signals", vec![
                "the face going utterly still — the expression that arrives before the mind has caught up with what the ears have heard",
                "a stillness that is not calm — the whole body frozen mid-gesture, a coffee cup halfway to the mouth that the hand seems to have forgotten it was holding",
                "the color draining from the face in a single visible wave, from forehead to neck",
                "an involuntary half-step backward — the body's older, wiser instinct putting distance between itself and what has just arrived in the room",
                "the head shaking 'no' in small, continuous, uncontrolled motions while the mouth forms no words at all",
                "a hand rising slowly to cover the mouth, as if to physically hold the news inside the body a little longer",
                "eyes widening, then narrowing, then searching the other person's face for the alternative explanation that is not coming",
                "the knees giving way gently — not a collapse so much as a lowering, the body finding the nearest chair or wall without consulting the mind",
                "the first single, barking laugh — the sound of the mind refusing the evidence in one involuntary protest before the silence closes back in",
                "sitting at a kitchen table at three in the morning, entirely still, while the rest of the house sleeps peacefully through the ruin",
                "reading the same text message seven times, trying to find a reading under which it means something else",
                "a trembling that is not cold — the hands shaking while the jaw sets hard against them",
                "the stare that refuses to blink, fixed on a floor tile, a coffee ring, a pattern in the wood — anything but the face of the person speaking",
                "walking the same slow circle through the dark house for an hour without turning on the lights",
                "a sudden, violent revulsion at physical touch — flinching away from a hand that until this morning would have been welcomed without thought",
                "cataloguing the objects of the shared life with new and terrible clarity — the photographs, the shared mug, the toothbrush, the jacket on the hook by the door",
                "tears arriving without warning, running down the face for a minute, and stopping without explanation — the grief coming through in shifts",
                "the physical inability to eat — bread turning to paper in the mouth, the stomach refusing to accept anything at all",
                "scrolling backward through old photographs, zooming in on the betrayer's face in each one, hunting for the exact moment the lie began",
                "a hand stilling over a drawer, a door handle, a phone — knowing that opening it will make the thing more real, and opening it anyway",
                "the head dropping forward onto a table, arms stretched out on either side — the posture of surrender to a weight too heavy to carry sitting upright",
                "the specific, slow ritual of taking a wedding ring off, turning it in the fingers, setting it down on the counter — and then picking it back up again without putting it back on",
                "a silent phone call to a friend in which nothing is said for the first thirty seconds, because the throat cannot yet produce the first word",
                "a slow, stiff walk across a room as if the bones had suddenly become breakable in the last five minutes",
                "sitting in a parked car after arriving home, the engine off, the hands still on the wheel, for a quarter of an hour",
                "the sudden, unsteady act of pouring a drink at a time of day that is not ordinarily a drinking hour",
                "a laugh and a sob arriving at the same time in the same breath, the body unable to choose which one it is having",
            ]),
            ("Internal Sensations", vec![
                "a literal physical blow felt in the center of the chest — the same neural pathways that carry the pain of a broken bone firing for a wound nobody in the room can see",
                "the stomach lurching as if the floor of the body had dropped a foot in a single second",
                "a sudden cold flooding the hands and feet while the chest burns — blood pulling to the core as the body readies itself to defend something it can no longer protect",
                "the ears ringing faintly, the room going slightly muffled, the world receding a few inches from the skin",
                "a tightness wrapping the throat tight enough that swallowing becomes a conscious act",
                "the heart rate climbing and staying climbed — hours later, days later, a baseline the body seems to have forgotten how to come back down from",
                "the stomach closing against food, against water, against even the suggestion of nourishment",
                "a crawling, restless unease under the skin — the body scanning for the next betrayal it cannot see yet but now knows to look for",
                "sleep shattering into fragments — the body jerking awake at two and three and four, the nervous system unwilling to stand down for anything",
                "a heaviness in the arms and legs as if gravity had increased slightly, specifically for this one body",
                "the hollow, sick realization that your own memory — of last week, of last month, of last year — can no longer be trusted at its own word",
                "a faint tremor that has settled into the hands and simply will not leave them for days",
                "an appetite for nothing except the one thing that will hurt more — more details, more evidence, more proof",
                "the chest cavity feeling newly empty — as though something that was there yesterday has been cleanly, surgically removed in the night",
                "a pressure building behind the eyes that does not release whether or not the tears come",
                "the particular exhaustion of a body that has been running its crisis response for forty-eight hours without once being allowed to power down",
                "a metallic taste in the mouth that arrives with the worst thoughts and fades during the quieter minutes",
            ]),
            ("Mental Responses", vec![
                "the discovery rewriting the past in real time — every memory shifting color, every kindness recoloring as cover, every absence recoloring as alibi",
                "the obsessive reconstruction of the timeline — when did it start, what was happening the week it started, what was I doing on the afternoons it was happening",
                "the specific, terrible thought arriving first and last: was any of it real",
                "going back through old messages, old calendars, old photographs with the cold attention of a forensic investigator, hunting for the first hairline crack in the story you were told",
                "the sudden distrust of your own perception — how did I not see it, what else am I not seeing, what else is sitting in plain sight waiting for me to find it",
                "the inability to rank the wounds — the lie, the humiliation, the loss of the future you had planned, the destruction of your own memory of the past — all arriving at full volume simultaneously, none willing to take a back seat",
                "the word 'we' becoming instantly, painfully past tense in every sentence you begin",
                "the strange, intrusive mental image of the betrayer in the moment of choosing — picturing them deciding, picturing them committing, picturing them deciding again the next time",
                "a catalogue of everyone who might have known — the friend who seemed awkward last month, the relative who changed the subject, the colleague who couldn't quite meet your eye — and the second, smaller betrayal arriving with every name added to that list",
                "the reflexive hunt for an explanation that would save the relationship — the desperate bargaining that is itself a symptom of the stage you are still inside",
                "the darkly practical thought intruding at the worst possible moment: the house, the money, the children, the shared calendar, the joint everything",
                "a rage that is not ordinary anger — a rage that remembers being love, and is hotter for having been love first",
                "the impossible question that will be asked a hundred times in the next month and never satisfactorily answered: how could you",
                "a shame that arrives uninvited and has no business being there — the quiet voice suggesting that somewhere along the way you must have caused this, or deserved it, or failed to prevent it",
                "the sudden, expanding conviction that everyone around you — friends, family, strangers on the bus — is almost certainly lying about something, and you have simply not caught them yet",
                "a quieter and deeper pain beneath the anger: the specific grief of mourning someone who is still alive and standing in the room across from you",
                "the slow realization that you now belong to a silent, recognizable population — the betrayed — that you could not see until today and will now see everywhere, on every face, in every crowd",
                "the dawning understanding that even if the whole thing could somehow be made right tomorrow, you will never again be the person who did not know",
                "the single moment — sharp as a needle — when the disbelief finally gives way and you understand that this happened and was real, and the feeling of something inside the chest giving up a fight it did not know it had been fighting",
            ]),
            ("Suppression Cues", vec![
                "answering 'how are you' with 'fine, you?' in a voice that is almost, but not entirely, at the correct pitch",
                "the smile that arrives a half-second late at every joke, assembled from component muscles rather than felt by anything underneath them",
                "excusing yourself to the bathroom at the dinner party and sitting on the closed toilet lid for five full minutes, breathing carefully, then washing your hands and returning to the table",
                "answering the betrayer's ordinary questions with short, polite, perfectly neutral answers while the knowledge hammers against the inside of the skull",
                "performing affection in public with the muscles of the face while the mind silently counts the minutes until you can stop",
                "a laugh that is two notches too loud and ends a beat too abruptly, papering over the silence where a normal reaction would go",
                "snapping at a waiter, a child, a colleague — the small sideways leakage of what cannot be said to the actual target, arriving at the wrong address",
                "doing the dishes with unnecessary care, aligning things, wiping the same counter twice — the rituals of normalcy performed so the hands have something to hold onto",
                "telling a story about your week and carefully editing out every detail that would crack the facade, leaving the story oddly shapeless and slightly the wrong length",
                "the extra-bright 'I'm fine, really' delivered to the friend who noticed something and asked twice",
                "sending the routine morning text, the routine goodnight message, continuing the choreography of the relationship while the music in your head has stopped playing altogether",
                "posting the ordinary photograph to the ordinary social media at the ordinary hour, the caption carefully identical in tone to one you would have written a week ago without thinking",
                "the careful, lawyerly phrasing in conversations with mutual friends — committing to nothing, admitting to nothing, watching their faces for the micro-signs that they already know",
                "the mask held in place until the car door closes behind you — and then the ten seconds of silent, wet, unbroken grief before the key turns in the ignition and the next performance begins",
                "the long exhale in the elevator on the way up to your own front door, shoulders being physically forced back into position, the rehearsal of a normal voice for the greeting you're about to say",
            ]),
        ]),
        ("Alienation", "The sense of being fundamentally separate from others — disconnection not as an ache but as a condition, the yearning itself gone quiet", vec![
            ("Physical Signals", vec![
                "standing at the edge of a group conversation, smiling at the appropriate moments, contributing nothing of substance",
                "a laugh arriving half a beat late, after a quick scan of the other faces to see whether this is the kind of thing that should be laughed at",
                "watching your own hand reach for a coffee cup as if it belonged to someone else who happens to be borrowing this body for the afternoon",
                "the slow drift toward the window at every party, the wall at every meeting, the edge of every room",
                "answering small-talk questions with short, perfectly correct answers while the attention is elsewhere entirely",
                "a long, blank look into a mirror — hunting for the recognition that is not quite arriving",
                "walking through a familiar neighborhood and not quite recognizing it, as if the street signs had been replaced overnight with signs for the same street",
                "picking up a photograph of yourself and studying it like a stranger's face",
                "a hand pausing on the door handle of your own home — not from fear, but from the faint, confused question of whether this is the right house",
                "the neutral half-smile worn like a piece of clothing — not faked, just no longer connected to any particular feeling",
                "leaving parties early without saying goodbye, because the goodbye ritual now feels too strange a performance to complete",
                "a small reflexive flinch away from casual physical touch — a shoulder, a handshake, a hand on the back — as if contact no longer mapped onto anything inside",
                "catching the eye of another person in a shop window and immediately looking away, not from rudeness but from a sense that the contact shouldn't have landed, because nobody was supposed to see you",
                "sitting in a restaurant booth watching the couple across from you argue with real feeling, and feeling nothing about them except the dim, clinical recognition that they are alive in a way you no longer are",
                "the slow, deliberate performance of morning routines — the toothbrush, the coffee, the shirt — each action conducted with the quiet self-consciousness of someone reading a manual for how to be a person",
                "speaking your own name aloud in an empty room and finding that it sounds borrowed",
                "the long pause in conversations when someone asks what you want, what you think, what you'd like to eat, what you feel like doing — and none of the answers are quite available from the inside",
                "a faint, reflexive stepping-back when a stranger asks for directions, as if the question had been addressed to someone standing a little behind you",
                "looking at your own reflection in a dark train window and not quite knowing whether the person looking back is you or a reasonable facsimile of you",
                "carrying whole conversations on autopilot, responding correctly at every turn, while the real attention floats somewhere near the ceiling watching it all happen",
            ]),
            ("Internal Sensations", vec![
                "the specific sensation of being one step behind your own body — every action arriving a half-second after the decision seemed to have been made by someone else",
                "a muted, underwater quality to all the senses — sound arriving slightly softened, colors slightly flattened, the world at a half-volume nothing in the room has turned down",
                "the body feeling borrowed — not injured, not wrong, just not quite the body you remember being inside",
                "a strange emptiness where a normal emotional reaction should have been — the space where the feeling was supposed to land and didn't",
                "a slow, heavy weight in the chest that is not sadness, because sadness has an object and this has none",
                "the particular exhaustion of performing human all day, and then discovering at night that there is no off switch — the performance simply continues into the dream",
                "the absence of appetite for most things, including the things that used to reliably bring comfort",
                "a cool, distant calm in situations that used to produce strong feelings — the calm is not peace, the calm is remoteness wearing peace's clothing",
                "the skin feeling a half-inch thicker than it should, as though a buffer had been installed between you and the world without your consent",
                "a quiet in the chest where the old wanting used to live — not resolved wanting, just missing wanting",
                "the sensation of watching your own face from slightly behind the eyes, as if piloting a machine with a small time delay",
                "a hollow in the center of the body that doesn't ache, doesn't demand, doesn't quite even register as loss — just a place where something used to be",
                "the faint, chronic fatigue of someone running translation software in the background of every conversation",
            ]),
            ("Mental Responses", vec![
                "the quiet, persistent observation that you do not quite belong in any room you find yourself in — and the recognition that this is no longer a new thought, only an old one arriving again",
                "the strange inability to remember what you want, followed by the stranger discovery that you are no longer entirely sure what wanting feels like",
                "a cool, detached noticing of other people's rituals — birthdays, weddings, Monday mornings, sports, grief — as if studying a foreign culture whose practices you've been asked to participate in politely",
                "the suspicion that the rules everyone else seems to follow have never been explained to you — and the corresponding suspicion that they were explained, once, and you happened to be looking the wrong way",
                "the specific, mild confusion of watching a colleague become excited about a promotion, a friend tear up at a wedding, a stranger cheer at a goal, and feeling nothing except the academic interest of a biologist observing a species",
                "the recurring thought, arriving without self-pity: whatever it is other people are doing when they say they are 'living', I do not think I am doing that",
                "looking at a job, a relationship, a home, a country, and recognizing each one as something assigned rather than chosen",
                "the quiet existential arithmetic — the awareness that your values and the values of the people around you no longer overlap in any meaningful place, and the absence of any surprise at that arithmetic",
                "a memory surfacing of a version of yourself who used to care about things — and the inability to locate where that version went or what replaced it",
                "the strange double consciousness of being present in a conversation while simultaneously watching yourself being present, noting your own responses with mild clinical interest",
                "the awareness that your actions produce effects but the effects do not quite feel like yours — as if you were moving levers in a machine whose output appears in some room you are never in",
                "the creeping question of whether anything you say or do today will produce an outcome you can recognize as belonging to you rather than to the role you've been cast in",
                "the quiet suspicion that the 'you' who should have been experiencing all this has gone somewhere else, and the observer left behind is doing a reasonable job of covering",
                "wondering, without urgency, whether other people feel this too and simply hide it better — or whether you are alone in this particular quality of removal",
                "the realization that loneliness would at least be an ache pointed toward reconnection — and this, whatever this is, is not loneliness, because the ache itself has gone quiet",
                "the thought arriving slowly and without drama: I am not quite here, and I have not been quite here for some time, and I am no longer sure when it began",
            ]),
            ("Suppression Cues", vec![
                "the bright, socially correct answer produced on cue to the 'how are you' — a phrase whose origin you no longer remember",
                "laughing at a joke because a laugh has arrived in the room at that moment — the decision made from the outside in, the sound produced on time",
                "the careful study of other people's reactions in order to know what your own should be",
                "mirroring posture, tone, facial expression from whoever is closest, as a method of passing for someone who belongs in the room",
                "saying 'same' and 'totally' and 'exactly' at the right intervals during a conversation you are not quite following",
                "making brief, correct eye contact and then looking down at the exact social distance that a listening person is supposed to look down at",
                "offering a pre-rehearsed opinion on a topic you have no real opinion about — recycled from a conversation last week, updated only in the small details",
                "the performance of small enthusiasms — the second drink, the weekend plan, the new restaurant, the interest in the other person's story — assembled from muscle memory rather than lifted from any feeling underneath",
                "deflecting deeper questions with humor, a practiced self-deprecating line, a quick question back — anything that returns the focus to the other person and closes the opening",
                "the careful maintenance of a social calendar and a public presence that together produce the appearance of a well-connected life",
                "posting the correct photograph to the correct platform at the correct hour, the caption assembled from what such a caption is supposed to say",
                "the short, safe conversation at the checkout, the elevator, the coffee shop — every small social transaction conducted at exactly the expected pitch, so that no one has any reason to ask whether anything is wrong",
            ]),
        ]),
    ];
    ...
    let flat_groups: Vec<(&str, Vec<&str>)> = vec![
        ...
        ("Sight — Light & Color", vec![
            ...
            "the pink-gold light that comes in low through east-facing windows and picks out every particle of dust as if introducing them one by one",
            "the first blue of morning — not yet light, more like the idea of light rising up from underneath the horizon",
            "a cold, thin dawn light the color of skim milk",
            "the moment the sun crests and the whole window-frame turns briefly into a shape of fire",
            "the watercolor light of a very early summer morning, when the grass is still grey and the sky has already gone lavender",
            "a sky the color of a bruise just starting to fade — yellow-green at the eastern edge, purple-grey overhead",
            // Golden hour / late afternoon
            "the gold-thickened light of late afternoon that makes every windowsill look like it owns something precious",
            "a raking, honey-colored light stretching all the shadows into long black versions of themselves",
            "the buttery slant of four-o'clock sun laying itself across a wooden floor in bars",
            "the warm, forgiving light that arrives twenty minutes before sunset and flatters everything equally",
            "a copper-colored light falling on brick, on skin, on the side of a bus, on the face of someone who has no idea how good they look in it",
            "the last gold of the day caught in the tops of the trees while the ground has already gone cool and grey underneath",
            // Noon / harsh / white
            "the flat, shadowless white of noon in high summer — light without mercy, too much to look at directly",
            "the bleached, colorless glare of midday on pale concrete, the kind of light that makes the eyes ache behind closed lids",
            "a hard, chromium light bouncing off the hood of a parked car",
            "light so bright it seems to have weight — pressing down on the shoulders, the tops of the feet, the crown of the head",
            "the washed-out, overexposed light of an August afternoon in which every color has been pulled half a step toward white",
            "the searing, metallic brightness of sun on a corrugated-iron roof",
            // Blue hour / dusk / twilight
            "the specific mauve of the ten minutes after the sun has set but before the streetlights have come on",
            "a blue-violet dusk that makes the neighborhood look like an old painting someone forgot to finish",
            "the eerie, underwater light of a deep winter afternoon — everything grey-blue and slightly unreal",
            "the last strip of daylight caught along the top of a far wall, retreating upward by the minute",
            "the bruise-colored sky of a hot summer evening just after a thunderstorm has moved off",
            "a soft, fading rose-orange along one horizon while the opposite horizon has already turned indigo",
            // Night / artificial (domestic)
            "the dim, domestic amber of a lamp with a cloth shade — a color that makes a room feel forgiven",
            "firelight on a wall, moving like a slow, soft animal that cannot quite settle",
            "the tiny, steady gold of a single candle at the far end of a long table, making every other light in the room look rude",
            "the warm, low glow of a kitchen seen from the far end of a dark garden, looking like the whole promise of home",
            "lamplight pooling on a book in an otherwise dark room, the light shaped exactly to what it loves",
            "the honey-colored flicker of a fire that has burned down to its patient stage",
            // Night / artificial (clinical and urban)
            "the green-white stutter of a fluorescent tube that has not quite decided to come on",
            "the cold, bright, forensic planes of an office at seven in the evening when no one is left but the cleaners",
            "the yellow sodium-orange of old streetlights — the color that makes everyone look slightly feverish",
            "the blue-white wash of a phone screen on a face in a dark room",
            "headlights sweeping across a ceiling and leaving nothing behind",
            "the specific sickly green of a hospital corridor at two in the morning",
            "a single red pilot light on an electrical socket, holding the dark at a steady one-inch distance",
            "the cold, bright square of an open fridge door casting its light on a midnight kitchen floor",
            // Moonlight and starlight
            "moonlight on snow — a light that seems to come from the ground as much as from the sky",
            "a full moon bright enough to throw a second, paler shadow beside your own",
            "starlight over open water — a thin, sharp, silver light, colder than it has any right to be",
            "the soft, milk-blue moonlight on a bedroom floor, the kind that makes small hours feel unfamiliar",
            // Weather-filtered light
            "the strange, too-bright gloom before a thunderstorm — every color oversaturated, every edge gone suddenly crisp",
            "the silver-grey light of a day of steady rain, softening every edge inside the room",
            "snow-light bouncing up through a window from below, reversing all the normal shadows on the ceiling",
            "the yellow-green light that arrives for ninety seconds before a tornado, a color the body knows to distrust before the mind does",
            "fog diffusing every streetlight into a soft round orb wearing a halo",
            "the cold white bloom of a lightning flash laid for one frame across a sleeping face",
            "sunlight breaking through after an afternoon of cloud and making the wet leaves look freshly varnished",
            // Light through things
            "sunlight coming through a stained glass window and laying four colors across a pew in careful parallel strips",
            "light through a half-drawn curtain, striping the bed in bars of bright and shade",
            "a shaft of light angling down through a cathedral window, thick with dust, standing in the air as if you could lean against it",
            "the rainbow edge a prism throws onto the wall at exactly three o'clock and loses by four",
            "sunlight filtered through green leaves into the shifting, coin-shaped bright spots that move across a lawn in summer",
            "the warm red of daylight through closed eyelids at the beach",
            "light through a glass of water, casting a trembling oval of brightness on the tablecloth next to it",
            // Colors as specific sensory events
            "the particular red of a sun-warmed apple in the second before you bite it",
            "the yellow of a lemon at the fruit stall that stops you on the street without your understanding why",
            "the deep, ink-wet blue of the sky in the minute after the first star appears",
            "the impossible green of the moment right before a summer storm, when the grass looks lit from within",
            "the bone-white of hospital sheets and the way they seem to refuse every other color in the room",
            "the black of an open mineshaft — a black that does not reflect, does not end, does not quite sit still",
            "the pink-coral of a sunburned shoulder glimpsed in a mirror",
            "a cornfield gone bronze in October, holding the last light longer than it has any right to",
            "the soft, washed-denim blue of a shirt that has been loved into near-transparency",
            "the oily rainbow sliding across a puddle in a gas station forecourt — the cheap, beautiful color of chemical accident",
            "the gold-brown of tea held up against a window",
            "the deep, private red of wine in a glass on a kitchen table at the end of a long day",
            "the dusty, flour-grey of a road under a dry summer sky",
            "the single sharp color of a poppy in a field of dun-colored grass",
            "the pale green of the underside of an olive leaf when the wind turns it",
            // Light as memory, light as mood
            "the strange, too-clear light of the first morning after a sleepless night — the world looking like a photograph of itself",
            "the light falling exactly the way it fell the last time you saw a particular person, and the way memory rides in on the light uninvited",
            "the ordinary, ungrieving afternoon light inside a room where someone has just died — ordinary in a way that feels almost offensive",
            "the gold light in a photograph of yourself at sixteen — a light you understand you cannot get back",
            "a shaft of sun finding a glass of water on a kitchen table and making it briefly holy",
            "the particular flat grey of the light through a hotel window in a city where you do not know anyone",
            "the soft, brown half-light of an old library in late afternoon, thick with the smell of paper",
            "the cold blue light of a screen catching on a face that has forgotten, for the moment, that the rest of the room exists",
        ]),
        ("Sight — Shadow & Darkness", vec![
            // Qualities and grades of darkness
            "a darkness that has weight — the kind that presses on the shoulders and the tops of the feet",
            "a darkness thick enough that a hand held in front of the face fails to appear",
            "the specific darkness of a rural night far from any town — older than city darkness, deeper, more indifferent",
            "a soft, granular darkness — made, it seems, of the small particles you almost see when the eyes close",
            "the low grey darkness of a suburban street under a half-moon, where you can see everything and nothing is quite itself",
            "a mineral darkness — cold, dry, silent — the dark of a cellar or a quarry or a sealed cave",
            "the wet darkness of a rainy city night, every surface reflecting a smaller, scattered version of whatever lights remain",
            "a furred, domestic darkness — the dark of a house you know well at three in the morning, friendlier than it has any right to be",
            "the slow-brightening dark of eyes adjusting, objects rising out of nothing like photographs developing in a tray",
            "a darkness loud with insects — the kind that has never, at any point in its long life, belonged to humans",
            "the thin, provisional darkness of a long northern summer night that never fully commits",
            "a smothering darkness with no air in it, the kind found in the back of a wardrobe or the corner of a tent",
            "the dark of a storm cloud pulled down over the afternoon, turning three o'clock into a second evening",
            // Shadows as events
            "the long shadow a single lamp post throws along a wet pavement, pointing like an accusing finger",
            "a shadow climbing the wall beside a climbing cat, doubled and exaggerated and somehow older than the cat",
            "the moving shadow of a branch against a curtain in the hour before dawn, indistinguishable from a person reaching",
            "the shadow that passes under a door when someone is walking the hallway at an hour no one should be walking",
            "a silhouette cut against the white of a frosted window — specific enough to recognize, blurred enough to doubt",
            "the shadow of a hand falling across a page, and being aware of it before hearing the footstep that made it",
            "a shadow that does not quite match the thing casting it — a shadow too tall, too long, too still for the object beside it",
            "the sharp, soft edges of a shadow thrown by a candle flame — crisp at the center, trembling at the rim",
            "the shadows of birds passing over a sunlit lawn, the lawn itself serenely unaware",
            "a shadow in a corner of a room that seems to have its own temperature, cooler than the rest of the darkness",
            "the thin black line of a shadow under a closed door, broken by two small shapes that stand and move and stand again",
            "the long dusk shadow of the house itself, reaching across the garden toward the hedge and pulling the day after it",
            "a shadow that waits exactly where a shadow should not be, neither cast by a visible object nor willing to resolve",
            // Partial darkness, the half-visible
            "the shape half-seen in the garden at dusk that might be a statue, a deer, or a person, and is almost certainly one of those three",
            "a face that is mostly silhouette with the glint of a single eye catching the last of the window light",
            "the figure at the far end of a corridor, distant enough to be any height, any age, any intention",
            "a doorway ajar into a dark room, the darkness inside it visibly thicker than the darkness of the hall it opens onto",
            "a staircase descending into a black where nothing is lit and nothing is answered",
            "a window across the courtyard with the curtains drawn and one narrow yellow edge of light bleeding around the fabric",
            "the bookshelves half-lit by a single lamp — the rows nearest the light crisp, the rows at the ends lost entirely to grey",
            "the hinge of a wardrobe door glinting once in the dark and refusing to glint again when you look",
            "the specific not-quite-shape of a person standing perfectly still against a darker background, detectable only by the piece of the background they are not",
            "a face half-lit by the light from a phone, the other half erased",
            "the dim outline of a figure behind a shower curtain, clearer than a shadow, less clear than a person",
            // Night environments
            "a country lane at midnight, the road visible only as the lighter stripe running between two black walls of hedgerow",
            "the dark of a forest at night when the canopy closes overhead and the sky above is only a rumor",
            "the sea at night — a darkness with motion in it, only the suggestion of a horizon where the black meets a marginally lesser black",
            "a hotel corridor lit only by the low strip of emergency light along the skirting board",
            "a city avenue at three in the morning, lit shop fronts making small islands of brightness in a dark ocean of closed places",
            "the dark of a rural barn in summer — warm, close, smelling of hay and animals and old rope",
            "a subway platform after the lights have failed, the far rails catching a thin shine from a distant tunnel",
            "the dark of a church at night, the stained glass gone black and the votive candles burning low in their iron stands",
            "the dark of a bedroom in a stranger's house, where none of the small landmarks of your own room meet the hand at the expected distance",
            "the dark of a car park seen from a lit window above, an orange haze of sodium light laid over the surface and nothing else visible at all",
            "a cottage garden after dark with the door open behind you, the known threshold of light at your back and the unknowable field of shadow ahead",
            "a railway cutting at night, the track gleaming like the only certain thing in the world",
            // Small light sources inside a larger darkness
            "a single match held up to a cavern wall — the flame revealing a circle of stone and leaving everything else to imagination",
            "the soft carried halo of a lantern through a field at night, the bearer visible only as a moving human-shaped pool of gold",
            "a torch beam swinging across a garden, lighting each thing in turn and forgetting each thing behind it",
            "the cold blue-white spot of a phone screen lighting one face in a dark parked car",
            "headlights on a distant road — two small, patient stars moving along the horizon at a speed the ear cannot yet hear",
            "a streetlamp in fog, its light not spreading outward but wrapping the lamp in its own small climate of brightness",
            "a candle in a window seen from the far side of a lake — a steady, impossible point of warm",
            "a lighter struck in the dark of a stairwell, the flame showing a face for one second and leaving only the after-image on the retina",
            "the weak orange of an electric heater bar in an unlit winter room",
            "the red pinprick of a cigarette moving through the dark of a porch, brightening for every inhalation",
            // Darkness and the body
            "the hand extended in a dark room, touching nothing where the wall should be",
            "the slow, careful walk through a room where the feet trust the floor and nothing else",
            "eyes wide and almost useless, taking in nothing, while every other sense works overtime to cover the gap",
            "the foot-on-the-missing-stair moment — the body continuing downward a half-inch into air that should have been solid",
            "the hand hunting for a light switch in the precise wrong area of the wall",
            "the moment an unlit room begins to give up its secrets to the eyes — the chair, the table, the shape of a person sitting very still in the far corner",
            "the held breath in the dark to listen better, and the way the silence seems to expand outward to meet it",
            "the sudden, involuntary freeze at a sound in a dark hallway, every muscle holding its last position",
            "the strange weight of your own hand when you cannot see it — as if the hand has become a thing you are lending",
            "walking toward a dark room with the specific reluctance of someone who knows the light switch is on the far wall",
            // Psychological, gothic, moral darkness
            "a darkness that feels watched — the unplaceable conviction that some part of it is looking back",
            "a darkness that has been in a room longer than any living thing currently in it",
            "the dark of a house whose owner has been dead a long time — arriving as a dense quality of its own, not merely an absence of light",
            "a shadow that seems to belong to a larger, older thing than the room can account for",
            "the cold, inherited dark of an attic, a cellar, a locked wing — the kind of dark that has absorbed whatever happened inside it and kept the record",
            "a darkness the mind has decided to populate — every coat on a door becoming a person, every dressing gown a figure",
            "the specific darkness of a child's bedroom at night seen from inside the child's point of view — larger than adult darkness, stranger, more morally loaded",
            "the darkness of a room where a secret has been kept for many years, thick with the shape of the secret even now",
            "a darkness that listens, the way rooms listen when something is about to be said or done in them",
            "the dark of an empty theatre after the audience has gone, still humming with the last three hours of attention",
            "a dark that seems to refuse the lamp — the bulb on, the corner still somehow not fully lit",
            // Darkness in memory, darkness at the edge of perception
            "the dark at the edge of a memory where the detail gives out and only the shape of the event remains",
            "the dark of the house you grew up in — the only dark your body truly trusts",
            "the remembered dark of a childhood power cut, the candles lit, the faces around them brighter than they ever were by day",
            "the dark your eyes make when you close them in full sunlight — red-orange, warm, unlike any other dark",
            "the dark behind the eyes in the second before sleep, beginning to shape itself into something that is no longer quite thinking",
            "the dark of a tunnel seen from the train, arriving and leaving too fast to feel like darkness at all",
            "the fragmentary dark of dreams, where the absence of light is a fact everyone has agreed on without explanation",
        ]),
        ("Sound — Loud & Harsh", vec![
            // Impact and blunt percussion
            "the full-body thud of a car door slammed in anger, the sound that makes windows rattle two streets away",
            "a heavy book dropped flat onto a hardwood floor — the single report that silences a room",
            "the low, meat-heavy sound of a fist meeting a wall and stopping",
            "a plate shattering on kitchen tile — the clean initial break, then the second, smaller catastrophe of the pieces finding their own way to the floor",
            "a steel filing cabinet falling over onto concrete, the sound arriving in two parts — the crash and the long aftershock of loose hardware settling",
            "the hollow thunk of a forehead meeting a table, harder than anyone in the room expected",
            "a hammer dropped on a metal workbench — brief, ringing, flatly unmusical",
            "the flat slap of a hand on a counter — a period, not a comma",
            "the muffled boom of a slammed door at the end of a carpeted hallway, softened by distance but carrying its intention intact",
            // Mechanical and industrial
            "the steady roar of a petrol generator in a quiet yard, drowning all other speech and leaving a high ringing in its wake",
            "the diesel-engine grumble of a lorry idling on a narrow street, the whole block vibrating through the soles of the feet",
            "a power drill's whine climbing, catching, climbing again — the pitch of a sound looking for something to chew",
            "the screech of a circular saw biting into green wood, and the brief almost-silence as the blade passes through a knot",
            "the repetitive metallic slam of a pile driver on a construction site, regular as a heartbeat and twice as loud",
            "the overhead thrum of a helicopter rotor arriving before the aircraft itself, a sound that occupies the whole chest cavity",
            "the bass-heavy pounding of a car subwoofer three cars behind at a traffic light, felt through the steering wheel before it reaches the ears",
            "a jackhammer on a street at nine in the morning, every strike a separate detonation arriving at the body faster than the mind can count",
            "the sustained howl of an industrial vacuum in a small carpeted room, reducing every other sound to pantomime",
            "the low, constant shudder of a refrigeration unit behind a supermarket loading bay, a sound you don't notice until you notice you cannot think",
            "the metallic clatter of a conveyor belt returning its empty crates, an unending three-beat rhythm that sets itself to the teeth",
            "the deep hum of an expressway at dusk carried across a field — a sound like a machine breathing in its sleep",
            // Explosive and concussive
            "the single flat crack of a rifle in a forest, bouncing back a quarter-second later from the far hillside",
            "a firework bursting overhead close enough to feel in the sternum, the light arriving before the noise by a perceptible fraction",
            "thunder directly overhead — not a distant roll but a shattering crack that sounds like something has physically broken in the sky",
            "the low concussive thump of a distant explosion, felt in the chest a half-second before the ears catch up",
            "a car backfiring at close range in a quiet suburb, the sound so sharp that every dog within three blocks answers it",
            "the specific, echoing bang of a heavy door slamming inside a stone building — a sound that takes three seconds to finish speaking",
            "the rolling boom of a summer storm arriving over open country, each peal taking longer than seems plausible to end",
            "a gas oven igniting with a soft initial whump and then settling into its quieter life",
            // Tearing, shattering, breaking
            "the sharp, almost musical cascade of a pint glass dropped on a tiled pub floor, fragments skating off in a dozen directions",
            "the slow, failing rip of heavy canvas tearing under too much weight — a sound that seems to contain its own decision",
            "the brittle crack of a tree limb giving way, followed by the whoosh of the fall and the dull impact at the end",
            "the industrial shriek of a metal hinge forced past its endurance",
            "a windscreen shattering — the initial impact, then the slower, strange music of the glass crazing in every direction at once",
            "the pop and long hiss of a pressurized container rupturing",
            "wood splintering under a boot — the dry, serial snap of fibers breaking in rapid sequence",
            "the bright, offended smash of a mirror hitting the floor whole and leaving as pieces",
            "a zipper giving way at the exact wrong moment, the teeth parting in one long, unhappy sound",
            // High-pitched and piercing
            "a smoke alarm triggering at three in the morning, the pitch precisely calibrated to find the softest part of the sleeping brain",
            "the single, sustained scream of a kettle that has been forgotten on the hob",
            "the continuous wail of a car alarm half a block away — a sound that turns from alarm into insult within thirty seconds",
            "the banshee whine of brake pads on a descending lorry, metal pleading with metal",
            "feedback from a microphone held too close to its speaker — the whole room cringing in a single involuntary wince",
            "an emergency siren rounding a corner, the Doppler slide from approach to departure so physical it feels like a hand pushed across the chest",
            "the specific electric shriek of a dentist's drill in the next room — heard with the whole body, not just the ears",
            "a chainsaw starting up behind a hedge on a Saturday morning, every bird in the garden falling silent at the first pull of the cord",
            "a child's scream at full pitch in a confined space — a sound that reorganizes adults in the room without their consent",
            "the high, thin keening of a dog that has been shut in and then forgotten, carrying through two closed doors",
            // Amplified, distorted, broadcast
            "a stadium PA announcing something at a volume no human voice was ever meant to reach, the words dissolving into reverb before the meaning can land",
            "distorted guitar feedback held past the end of a song, the whole room becoming a single overdriven frequency",
            "a police bullhorn clipping every vowel — the speech pattern of a machine trying to impersonate patience",
            "a loudspeaker mounted on a van moving slowly down a street, the sound blurred by motion and reflected off every parked car",
            "a pub television turned up too loud for the small room — the bar commentary colonizing every conversation within reach",
            "the fuzzy roar of an unintelligible platform announcement in a cavernous railway station",
            "the bass from a club on the ground floor travelling up through the legs of a chair two stories above",
            "a bad phone connection at full volume — speech turning into static turning into speech again",
            // Crowds and human-mass sounds
            "the collective roar of a stadium crowd after a goal — a single organism finding its voice",
            "a crowd at a rally chanting in unison, the rhythm carrying into the feet of people three streets away",
            "the chaotic, layered noise of a school hallway at the change of classes — no single sound recoverable from the mass",
            "the riot-edge sound of a crowd just before it becomes a mob: a particular braided noise of shouting and glass and running feet",
            "a pub football crowd reacting to a missed chance — a rising groan, a shared wince turned into one sound",
            "a marching band approaching from around a corner, the brass arriving before the drums before the bodies",
            "applause in a closed auditorium that goes on a beat too long, turning from gratitude into a kind of demand",
            "the jeer of a packed market street when a price is named aloud, the laughter moving down the stalls in a wave",
            // Weather as harsh sound
            "hail on a corrugated-iron roof — the steady drum turning briefly into a roar and back into a drum again",
            "wind howling around a chimney, a sound that seems to come from inside the house as much as outside it",
            "rain on a tin roof hard enough to make conversation physically impossible",
            "a tree coming down in a storm — the long, groaning crack, the whistling fall, the earth-shaking finish",
            "the high whistling of wind through a broken window, rising and falling with the gusts",
            "thunder rolling along the underside of a low cloud layer, taking what feels like a full minute to finish its sentence",
            "a blizzard wind pressing on the walls of a wooden cabin, every beam audibly taking the strain",
            "surf against a shingle beach during a gale — rounded stones grinding each other in every withdrawing wave",
            // Voice, shouting, human harsh
            "a scream cutting across a quiet park in the middle of the day — the kind that stops every other sound for a long second afterward",
            "the raw, animal howl of someone in real grief — a sound that lifts the hair on the back of every neck within earshot",
            "a sergeant's bark on a parade ground, trained to travel without losing its edge",
            "the specific hoarse shout of a parent losing patience — the voice already tearing at itself by the second syllable",
            "a drunk man yelling in a night street, consonants half-landed, vowels running into each other",
            "the sharp, cracking shout of fear across a work site — the sound that makes every body turn before the mind catches up",
            "an argument through a thin wall, the exact words lost but the shape of accusation perfectly clear",
            "the ugly, rising cadence of a playground fight — the second before the first blow lands",
            "a baby's peak wail in a confined room — pitched so that physics itself seems to take the baby's side",
            // Mixed modern and urban noises
            "a car horn held too long in traffic, stretching from signal into complaint into threat",
            "the rapid, nasal beep of a reversing truck — four beeps, a pause, four beeps, a pause, the whole morning measured against it",
            "the stuttering whine of a moped accelerating through a narrow lane, a sound that sounds personally aimed",
            "a leaf blower at the neighbor's fence on a Sunday morning — the particular pitch of minor civic betrayal",
            "the insistent electronic chirp of a supermarket checkout scanner, multiplied across twenty lanes into a single soft torment",
            "the rumble and huff of a city bus pulling away from a stop, the diesel thickening the air with its own punctuation",
            "the brief, sharp buzzer of an industrial door lock releasing, the sound louder than it has any reason to be",
            "the chunk-chunk-chunk of a washing machine trying to balance an uneven load, the whole floor reporting to the ceiling below",
            "the clash and clatter of metal scaffolding being loaded onto a truck before dawn on a residential street",
        ]),
