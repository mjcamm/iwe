...
fn seed_starter_data(conn: &Connection) -> rusqlite::Result<()> {
    ...
    let groups: Vec<(&str, &str, Vec<(&str, Vec<&str>)>)> = vec![
        ...
        ("Defeat", "The heavy acknowledgment that effort has failed and the outcome cannot be changed", vec![
            ("Physical Signals", vec![
                "the shoulders dropping all at once, not a gradual slump but a sudden release, as if the cables holding them up have been cut",
                "the head lowering until the chin nearly rests on the chest, the neck surrendering the effort of keeping the skull upright",
                "hands going limp in the lap, palms up, fingers loosely curled — the posture of someone who has let go of whatever they were holding onto",
                "a long, audible exhale — not a sigh but an emptying, the lungs releasing everything they had in reserve, the sound of a body deflating",
                "the spine curving forward, the torso folding over the knees, the body collapsing inward like a structure losing its load-bearing walls",
                "eyes unfocused and aimed at nothing, the gaze dropping to the floor or the middle distance and staying there, no longer searching for solutions",
                "pushing away from the desk, the table, the workstation — the hands shoving the task away with a finality that says it's over",
                "the slow, heavy sit — dropping into a chair as if the legs have simply stopped cooperating, the landing graceless and complete",
                "arms hanging at the sides like dead weight, swinging slightly with each step, no longer participating in the body's locomotion",
                "the jaw going slack, the mouth falling slightly open, the facial muscles abandoning the expression they were maintaining",
                "rubbing both hands down the face slowly, pulling the features downward, the gesture of someone wiping away the last of their composure",
                "movements becoming slow and heavy, as if the air has thickened to water and every gesture requires swimming through it",
                "staring at the evidence of the loss — the scoreboard, the letter, the screen, the locked door — without moving to change it or look away",
                "the voice going flat and quiet, stripped of inflection, each word arriving with the minimum energy required to make it audible",
            ]),
            ("Internal Sensations", vec![
                "the dorsal vagal complex activating — heart rate dropping, blood pressure falling, the body shifting into its most ancient shutdown mode, the neurological white flag",
                "a heavy, sinking sensation in the chest, as if the sternum is being pressed inward by a hand that isn't there, the weight of the outcome made physical",
                "all muscular tension releasing at once — not the relief of relaxation but the collapse of a system that has stopped trying to hold itself together",
                "the stomach hollowing out, a gutted emptiness that isn't hunger but absence, as if something essential has been removed from the core",
                "a cold numbness spreading from the center outward, the extremities going distant, the body beginning to shut down its periphery",
                "the specific exhaustion of spent adrenaline — the crash that follows sustained effort, the chemical aftermath of a fight that didn't work",
                "the throat aching with a lump that isn't quite tears, the body caught between crying and the inability to summon even that much energy",
                "a heaviness in the limbs that makes raising an arm feel like lifting concrete, the muscles refusing to engage for anything non-essential",
                "the head throbbing with a dull, diffuse pressure — cortisol's hangover, the metabolic bill arriving after the crisis has been lost",
                "a ringing silence inside the skull, the mental chatter that was strategizing and problem-solving suddenly gone, replaced by a static hum of nothing",
            ]),
            ("Mental Responses", vec![
                "the moment of recognition arriving with absolute clarity: it's done, it's over, there is nothing left to try — the mind's final audit returning a zero balance",
                "the inner voice going quiet, the constant strategist who was offering options and alternatives falling silent mid-sentence, having run out of moves",
                "the retrospective cascade — every decision, every turning point, every moment where a different choice might have changed the outcome, all of them arriving at once",
                "the thought 'I should have' repeating on a loop, each iteration swapping in a different verb: known, tried, listened, stopped, started, stayed",
                "the strange, numb peace that sometimes follows the worst moment — the relief of certainty after the agony of hope, the war over even if you lost it",
                "identity contracting: the defeat becoming a fact about the self rather than an event that happened to the self",
                "the inability to project forward, the future going blank, the mind refusing to render what comes next because it can no longer trust its own predictions",
                "a savage, irrational anger at the people who are still trying, still hoping, still fighting — the fury of the finished at the not-yet-finished",
                "the mathematical finality: adding the remaining resources, subtracting what's needed, and arriving at a number that is not enough — the arithmetic of defeat",
                "the thought surfacing unbidden: what was the point — not a question but a statement, the mind reclassifying the entire effort as waste",
            ]),
            ("Suppression Cues", vec![
                "the jaw reclenching, the teeth coming together, the face reassembling itself into something harder — the mask hammered back into place over the rubble",
                "standing when the body wants to sit, straightening when it wants to fold — the manual override of posture costing everything that's left",
                "the clipped, practical pivot to logistics: 'so what happens now' or 'what do we need to do' — converting devastation into a procedural checklist",
                "congratulating the winner with a handshake and a smile that engages no muscle above the mouth, the social ritual performed on autopilot",
                "making a joke about the loss, the humor arriving dry and flat, the laugh that follows sounding like it was borrowed from someone else",
                "retreating to a private space — a car, a bathroom, a stairwell — to let the face collapse where no one can see the cost",
                "busying the hands with cleanup: packing a bag, clearing a desk, closing tabs — the body performing the rituals of ending while the mind is still catching up",
                "the controlled 'it is what it is' delivered in a steady voice, the cliché serving as a tourniquet, stopping the bleeding long enough to leave the room",
                "deflecting sympathy with 'I'm fine' or 'it doesn't matter' — each word a small lie told not to the listener but to the self",
                "channeling the remaining energy into planning the next attempt, the comeback — not because the will is there but because the alternative is feeling this",
            ]),
        ]),
        ("Resignation", "Defeat accepted — the quiet release of fighting and the hollow settling into what is", vec![
            ("Physical Signals", vec![
                "the slow, deflating sigh — not sharp like frustration or shaky like grief but long and even, the sound of pressure leaving a system that has stopped maintaining it",
                "the shoulder shrug that doesn't rise all the way, a half-gesture, the body's shorthand for 'it doesn't matter' delivered without the energy for full articulation",
                "movements becoming economical and unhurried, stripped of urgency, each gesture performed at the minimum speed required — why rush toward nothing",
                "the gaze landing on surfaces without fixing on them, the eyes open but not searching, not tracking, just receiving whatever falls into their field",
                "sitting back in the chair with the full weight committed, the spine making contact with every inch of the backrest, the posture of someone who isn't getting up soon",
                "the hands resting still for the first time — no fidgeting, no reaching, no gripping — palms flat on thighs or loosely draped over armrests, the restlessness gone",
                "a monotone creeping into the voice, the pitch flattening, the melody of speech reduced to a single note, each sentence ending where it started",
                "the slow headshake that isn't disagreement but acknowledgment — the small, lateral motion of someone confirming to themselves what they already knew",
                "shuffling steps, the feet barely lifting, the gait of someone walking without a destination, propelled by habit rather than intention",
                "letting go of objects without placing them — a pen dropped on the desk, a bag set down wherever, belongings released as if their arrangement no longer matters",
                "the face settling into a neutral mask, the muscles of expression at rest, neither smiling nor frowning — the features of someone who has stopped performing for an audience",
                "staring at a fixed point for too long — a crack in the wall, a stain on the carpet, a spot on the ceiling — the eyes resting on nothing because nothing requires their attention",
                "personal grooming declining by degrees: an unironed shirt, unwashed hair, the shoelace that stays untied — small surrenders accumulating at the margins",
            ]),
            ("Internal Sensations", vec![
                "a pervasive flatness in the chest — not the ache of defeat or the hollowness of grief but an absence, as if the emotional register has been set to zero",
                "the parasympathetic system dominant and unchallenged, the heart beating slow and steady, blood pressure low, the body in conservation mode with nothing to conserve for",
                "a heaviness that isn't painful so much as gravitational, the limbs weighted not by exhaustion but by the removal of the energy that once moved them with purpose",
                "the absence of the internal clock — no sense of urgency, no countdown, no awareness of time passing because there is nothing time is passing toward",
                "breathing shallow and automatic, the lungs operating at their lowest functional setting, each breath just sufficient and nothing more",
                "the stomach neither hungry nor full, the appetite not suppressed but simply absent, the body's maintenance alerts turned down to a whisper",
                "a dull, ambient ache that has no specific location — the shoulders, the lower back, the jaw — as if the body is slowly rusting from disuse",
                "the strange calm of the nervous system at its baseline, no spikes of anxiety or dips of dread, just the flat hum of a machine running idle",
                "emotional stimuli bouncing off the surface — good news, bad news, a compliment, an insult — each one registering and failing to penetrate, like rain on glass",
                "the occasional flicker of feeling — a pang, a twinge, a flash of the old anger or the old want — arriving and fading before it can gain traction, a pilot light that won't catch",
            ]),
            ("Mental Responses", vec![
                "the interior monologue simplifying to a handful of phrases on rotation: it doesn't matter, it won't change, there's no point — the vocabulary of surrender",
                "the future collapsing from a horizon to a wall — no plans, no goals, no projections, just the next hour and the hour after that, time reduced to sequence",
                "the strange relief of lowered expectations — the removal of hope as the removal of a burden, the lightness of no longer carrying what might have been",
                "a detached clarity about situations that used to provoke emotion — seeing the pattern, understanding the dynamic, and no longer caring enough to engage with it",
                "the 'what's the point' arriving not as despair but as a genuine, dispassionate assessment — the mind having run the numbers and concluded the return isn't worth the investment",
                "other people's urgency becoming bewildering, almost alien — watching someone fight for something and feeling the distance between their energy and your own",
                "decisions becoming effortless not from confidence but from indifference — any option is as good as any other when none of them matter",
                "the occasional recognition of who you were before this, the person who cared, who tried, who fought — observed from a distance, like watching a home movie of a stranger",
                "the quiet negotiation: this is my life now, this is what it looks like — the mind reshaping its model of the world to accommodate the permanent absence of the thing that was wanted",
                "thoughts arriving pre-concluded, the deliberation phase skipped entirely — not 'should I try again' but 'I won't try again,' the decision made somewhere below consciousness",
            ]),
            ("Suppression Cues", vec![
                "going through the motions with mechanical precision — showing up, completing tasks, answering questions — the performance indistinguishable from engagement to anyone not looking closely",
                "the practiced 'I'm okay with it' delivered without bitterness and without conviction, a sentence that has been said so many times it no longer costs anything to produce",
                "agreeing to plans, accepting invitations, saying yes with a tone that technically qualifies as willing — compliance passing for enthusiasm in a room that isn't paying attention",
                "keeping the routine intact — the alarm, the commute, the meals, the bedtime — structure substituting for motivation, the scaffolding holding up a building no one is inside",
                "offering advice to others with genuine clarity, the mind fully capable of seeing solutions to problems it has stopped applying to its own life",
                "the brief smile that surfaces when it's expected — reflexive, socially correct, and gone the moment the other person looks away",
                "redirecting conversations about feelings toward logistics, facts, schedules — anything with a concrete answer, anything that doesn't require accessing the flat place behind the ribs",
                "framing the resignation as maturity: 'I've made my peace with it' or 'I've accepted it' — the language of growth applied to the experience of giving up",
                "performing small acts of care for others — making coffee, holding doors, remembering birthdays — the outward signals of a functioning person maintained while the inner one has gone quiet",
                "the single honest moment allowed per day: the pause in the car before going inside, the stare at the ceiling before sleep, the exhale that carries everything the mouth refused to say",
            ]),
        ]),
        ("Numbness", "The absence of feeling as a protective response to too much — emotion's circuit breaker", vec![
            ("Physical Signals", vec![
                "the face going completely still — no micro-expressions, no twitches, no reflexive reactions, the muscles of expression powered down like a screen gone dark",
                "eyes open but unfocused, the gaze passing through objects and people as if they're made of glass, the pupils neither dilating nor contracting, just fixed",
                "movements becoming mechanical and precise, each action performed with the eerie competence of someone operating their body by remote control",
                "responding to questions after a beat too long, the delay not from thinking but from the signal having to travel a greater distance to reach wherever the self has retreated to",
                "the hand reaching for a cup, lifting it, drinking, setting it down — each motion correct but stripped of the small unconscious adjustments that make gestures look human",
                "no flinching at sudden sounds, no startling at a touch on the shoulder, the reflexes muted as if the volume on the nervous system has been turned to its lowest setting",
                "sitting in the same position for an unnaturally long time without shifting, adjusting, or fidgeting — the body forgetting its own discomfort",
                "the voice arriving flat and even, each word the same volume and pitch as the last, the prosody of speech reduced to a straight horizontal line",
                "being spoken to and responding appropriately while the eyes suggest no one is home — the social autopilot executing its protocols in the absence of the pilot",
                "the absence of tears where tears would be expected, the absence of anger where anger would be warranted — the conspicuous nothing where something should be",
                "walking past something that should provoke a reaction — a beautiful sunset, a crying child, a slamming door — with the same unchanged pace and expression",
                "hands resting in the lap, palms down, fingers still, exhibiting none of the self-touching or fidgeting that accompanies every other emotional state",
                "blinking less than normal, the eyelids operating on a slower cycle, the face wearing the slightly glazed look of someone watching a screen they stopped paying attention to long ago",
            ]),
            ("Internal Sensations", vec![
                "the endogenous opioid system flooding the amygdala — the brain's own painkillers deployed at dosages meant for physical trauma, dampening every emotional signal to a whisper",
                "the body feeling distant, as if observed from slightly above and behind — the proprioceptive sense muffled, the hands feeling like gloves, the feet like shoes worn by someone else",
                "a cotton-wool thickness between the self and every sensation, sounds arriving muted, light arriving dimmed, touch registering as pressure without texture",
                "the heart beating at a rate the person cannot feel — no pounding, no fluttering, no awareness of the pulse at all, as if the cardiovascular system has been disconnected from conscious monitoring",
                "the absence of the gut's commentary — no butterflies, no sinking, no churning — the stomach silent for the first time in memory, the enteric nervous system on mute",
                "skin that doesn't register temperature properly, cold and heat arriving as information rather than sensation, a cup of coffee warming the hands without the warmth being felt",
                "a heaviness that isn't localized anywhere because it's everywhere — the body wrapped in invisible weight, each movement requiring slightly more effort than it should",
                "the specific vertigo of depersonalization: the ground feeling uncertain, distances seeming wrong, the room occasionally appearing flat, like a photograph of itself",
                "a ringing quietness inside the skull, the internal monologue reduced to a murmur, thoughts arriving preformed and departing without being examined",
                "pain registering as a fact rather than a feeling — stubbing a toe, biting a tongue — the nerve signal arriving and being acknowledged without the suffering that should accompany it",
            ]),
            ("Mental Responses", vec![
                "the awareness that you should be feeling something — grief, rage, terror — and the clinical observation that you are not, like reading a medical chart and finding it blank",
                "thoughts arriving in third person: 'she is sitting in a chair' rather than 'I am sitting in a chair' — the mind narrating the self from the outside",
                "the world taking on a dreamlike quality, edges softening, colors muting, events seeming to occur behind a pane of glass that the mind cannot reach through",
                "watching other people cry or laugh or shout and understanding intellectually what they are feeling without any corresponding echo inside, like reading about weather in a country you've never visited",
                "the eerie efficiency of the mind when it's no longer burdened by emotion — seeing solutions, making decisions, processing information with the cold clarity of a calculator",
                "time losing its texture, hours passing without markers, a morning and an afternoon occupying the same featureless expanse — the clock moving but the experience not accumulating",
                "the occasional probe: trying to feel something on purpose, reaching for anger or sadness the way you'd reach for a light switch in a dark room, and finding nothing there",
                "a distant, theoretical concern that this state might be permanent — the thought arriving without the anxiety that should accompany it, which is itself the evidence",
                "memories playing without their emotional soundtrack — the images present, the facts intact, but the feeling stripped away, like watching a home movie with the audio removed",
                "the recognition that you are performing normalcy from memory rather than from feeling — saying the right things, making the right faces, because the body remembers the choreography even when the music has stopped",
            ]),
            ("Suppression Cues", vec![
                "there is nothing to suppress — that is the nature of numbness, and the suppression cues become the inverse: the effort to feel rather than the effort to hide",
                "pinching the skin, pressing fingernails into the palm, seeking any sharp sensation that might punch through the insulation and reconnect the circuit",
                "deliberately seeking stimuli that should provoke a response: a sad song, an old photograph, a place with memories — testing the system, checking for signs of life",
                "saying 'I'm fine' and meaning it in the most literal, emptiest sense — not hiding pain but reporting the genuine absence of it, which is its own kind of wrong",
                "forcing a laugh at a joke because the silence where the laugh should be is more conspicuous than the performance",
                "making eye contact with deliberate effort, holding it for the socially correct duration, because the natural instinct to connect has gone offline and the protocol must be run manually",
                "telling someone 'I should be more upset about this' — the closest the numb person comes to admitting the malfunction, framing the absence as a puzzle rather than a crisis",
                "going through the rituals of grief or celebration because the calendar says it's time — lighting the candle, raising the glass, saying the words — the ceremony performed without the sacrament",
                "seeking physical exertion — a run, a long walk, cold water on the face — anything that forces the body to generate sensation and report it to headquarters",
                "the moment when feeling returns, arriving not as relief but as a wall of everything that was held back, the circuit breaker flipping and the full current hitting at once",
            ]),
        ]),
