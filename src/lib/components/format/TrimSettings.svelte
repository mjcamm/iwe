...
<div class="custom-section">
  <h4 class="custom-section-title">Trim</h4>
  <p class="custom-placeholder">Custom trim dimensions (overrides target preset), bleed, safe area. For non-standard paper sizes.</p>
</div>
